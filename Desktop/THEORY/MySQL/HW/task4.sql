...
SELECT cats.id, cats.name, shops.shopname AS shop_name
FROM cats
...
WHERE cats.name IS NULL OR cats.name NOT IN ('Murzik', 'Zuza');

-- Вывести название и цену для всех анализов, которые продавались 5 февраля 2020 и всю следующую неделю:

SELECT analysis.an_name, analysis.an_price
FROM Analysis
JOIN Orders ON Orders.ord_an = an_id
WHERE Orders.ord_datetime >= '2020-02-05' AND Orders.ord_datetime < '2020-02-13';